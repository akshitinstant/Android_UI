...
class GridActivity : AppCompatActivity(), ClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind= ActivityGridBinding.inflate(layoutInflater)
...
//                    Toast.makeText(this@GridActivity, "No Data Found", Toast.LENGTH_SHORT).show()
                    bind.gridRecycler.visibility=View.GONE
                    bind.noResultText.visibility=View.VISIBLE
                } else {
                    bind.gridRecycler.visibility=View.VISIBLE
    ...
    fun initializeAdapter(){
        ...
        val recyclerView=bind.gridRecycler
        recyclerView.layoutManager= GridLayoutManager(this, 2)
        adapter= GridAdapter(this, myVM.list)
    ...
    override fun customClickListener(dog: Dog) {
        ...
        supportFragmentManager.beginTransaction().replace(R.id.container, dogP).addToBackStack(null).commit()
    }
